    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("provider", models.CharField(choices=[("openai", "OpenAI"), ("anthropic", "Anthropic"), ("gemini", "Gemini"), ("deepseek", "DeepSeek")], default="openai", max_length=50)),
                ("llm_model", models.CharField(blank=True, default="", max_length=50)),
                ("status", models.CharField(choices=[("running", "Running"), ("completed", "Completed"), ("failed", "Failed"), ("awaiting_approval", "Awaiting Approval"), ("rejected", "Rejected")], default="running", max_length=20)),
