...
const HelpdeskPublicRequestPage = observer(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      {portal?.enable_chat && (
        <div className="mt-8">
          <div className="focus-within:border-accent-subtle focus-within:ring-primary/20 shadow-sm relative flex flex-col gap-2 rounded-md border border-subtle bg-surface-1 transition-all focus-within:ring-1">
            <textarea
              value={newComment}
