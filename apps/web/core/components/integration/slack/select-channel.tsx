  ...
  return (
    <>
      {projectIntegration ? (
        <button
          type="button"
          className={`bg-label-grey-bg-strong relative inline-flex h-4 w-6 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none`}
          role="switch"
          aria-checked
          onClick={() => {
